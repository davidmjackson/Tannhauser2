...
- [ ] Aim-to-focus markers (marker highlights the station you point at)
...
Rung 2, Step 1, on branch `rung2-planets-stations`. Task 1 (three-planet layout)
is committed; next up is Task 2 (aim-to-focus markers).
